...
激怒は1分間持続する。ただし、君が気絶状態になるか、前回の自分のターン終了時からずっとダメージを受けることも敵対的なクリーチャーを攻撃することもないままターンを終えた場合、激怒はその時点で終了する。加えて君は自分のターンにボーナス・アクションを用いて激怒を終えることもできる。

『バーバリアン』表に示されている回数だけ激怒したなら、君は大休憩を終えるまでは再び激怒できなくなる。
  
### 鎧わぬ守り
いかなる鎧も着用していない間、君のアーマー・クラスは(10+【敏捷力】修正値+【耐久力】修正値)に等しい。盾を使用していてもこの利益を得られる。
...
君は自分から見える効果、例えば罠や呪文などに対して行う【敏捷力】セーヴィング・スローに有利を得る。この利益は、君が盲目状態、聴覚喪失状態、無力状態のいずれでもない時にだけ得られる。
...
加えて君は戦闘開始時に不意を討たれたとしても、無力状態でない限り自分の最初のターンに通常通り攻撃できる。ただし、そうするためにはそのターンの一番初めに激怒に入らねばならない。
...
### 倒れずの激怒
11レベル以降、君は激怒を力として、深い傷を負っていても戦い続けられるようになる。激怒している最中にヒット・ポイントが0になり、しかし即死はしなかった場合、君は難易度10の【耐久力】セーヴィング・スローを行うことができる。セーヴに成功したなら、君のヒット・ポイントは0ではなく1になる。
...
相手クリーチャーがセーヴィング・スローに成功した場合、以後24時間君はこの効果をそのクリーチャーに対して使用できない。
